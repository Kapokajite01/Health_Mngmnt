...
echo "<script>window.location='labconsultation?affid=$affnumber&dtconsult=$mydate&case=Nouveau';</script>";	
...
echo "<script>window.location='labconsultation?affid=$affnumber';</script>";	
