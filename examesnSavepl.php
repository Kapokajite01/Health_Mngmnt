...
echo "<script>window.location='nplanning1?affid=$affnumber&dtconsult=$mydate&case=Nouveau';</script>";	
...
echo "<script>window.location='nplanning1?affid=$affnumber';</script>";	
