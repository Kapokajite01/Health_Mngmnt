...
echo "<script>window.location='labmaternite?affid=$affnumber&dtconsult=$mydate&case=Nouveau';</script>";	
...
echo "<script>window.location='labmaternite?affid=$affnumber';</script>";	
