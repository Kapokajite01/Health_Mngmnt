...
$dt=$_POST['date'];
$number=$_POST['searc'];
$result = ("SELECT id,names,lname,affiliate_number,date FROM patient  WHERE date='$dt' AND affiliate_number LIKE '%$number%'"); 
...
if($insur == 'RAMA/RSSB' OR $insur== 'MEDIPLA' OR $insur=='RADIANT' OR $insur=='MMI'){
	...
	$ticketmod1 = $ticketmod+$modticket;
				...
				<td><a href="edit_hosp1?consid=<?php echo $row['up_id']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
			<?php
		 } 
        // close table>
        echo "</table>";
