...
echo "<script>window.location='nmaternite1?affid=$affnumber&dtconsult=$mydate&case=Nouveau';</script>";	
...
echo "<script>window.location='nmaternite1?affid=$affnumber';</script>";	
