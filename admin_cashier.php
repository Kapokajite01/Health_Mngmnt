...
if($sql>0) {header("location:http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/admin_cashier");
}else{
...
<ul>
			...
			<li><a href="admin_cashier">Receptionist</a></li>
			<li><a href="admin_cashier">Stock Manager</a></li>
    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysqli_fetch_assoc( $result )) {
				...
				?>
				<td><a href="update_cashier?username=<?php echo $row['username']?>"><img src="images/update-icon.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_cashier?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
		...
		<?php echo $message;
			  echo $message1;
			  ?>
		<form name="form1"  onsubmit="return validateForm(validation_script.js);" action="admin_cashier" method="post" >
