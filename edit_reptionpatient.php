...
echo "<table class='blueTable'>";
		 ...
		 <th>affectation</th><th>Insurance</th><th>Family code</th><th>Date</th><th>Edit</th</tr>";
        while($row = mysqli_fetch_assoc( $resultselect )) {
				...
				<td><a href="edit_reptionpatient1?id=<?php echo $row['id']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
			<?php
		 } 
        echo "</tr></table>";
}
