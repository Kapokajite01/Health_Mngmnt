...
echo "<script>window.location='nconsultation1?affid=$affnumber&dtconsult=$mydate&case=Nouveau';</script>";	
...
echo "<script>window.location='nconsultation1?affid=$affnumber';</script>";	
