...
<div id="top-bar">
	...
	<li class="v-sep"><a href="consultation" class="round button dark menu-user image-left"> <strong>Consultation  Report </strong></a>
<ul>
		<li class="v-sep"><a href="consultation" class=" stock-tab" onClick=window.open("consultationReport","Ratting","width=1200,height=1800,left=200,scrollbars=yes,toolbar=0,status=0,"); value="MEDICINES"><strong>Consultation report </strong></a></li>
					</ul> 
...
function my_encrypt($data, $key) {
	...
	if($branch != ''){
	?>
	<td><a href = "labconsultation?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></td>
	<?php
	}
	else{
		
	?>
	<td><a href = "labconsultation?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
	<?php
	}
	?>
	</tr>
<?php
	...
	{
	?>
	<td><strong><a href = "orientations?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"> Select</a></td>
	<?php
	}
	else
	{
		...
		{
		?>
		<td><strong><a href = "orientationsRed?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></td>
	...
	<?php
		...
		{
		?>
		<td><strong><a href = "nconsultation1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></a></td>
	
	<?php
		}
		else if($origine == 'Consultation')
		{
		?>
		<td><strong><a href = "nconsultation?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
	...
	<?php
		...
		if($branch ==''){
			?>
		<td><strong><a href = "nconsultation1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="black"><strong>select</font></a></td>
...
<td><strong><a href = "nconsultation1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
<?php		
...
<?php
	...
	<td><strong><?php echo $newDate = date("d/m/Y", strtotime($rowval['date']));?></td>
	<td>
	<strong><a href = "consultation_tests?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a>
