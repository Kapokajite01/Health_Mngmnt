...
$result = ("SELECT id,names,affiliate_number,lname,carnet,phtocopy,transfert,consultatiom,insurance,date from patient where date >= '$date' AND date <= '$date1' ORDER BY id DESC");
$sumconsult=0;
$sumcarnet=0;
$sumphotocopy=0;
$sumtransfer=0;
