	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			$_SESSION['logo']=$line->log; 
			 ?>
                        <a href="#" id="company-branding-small" class="fr"><img src="<?php if(isset($_SESSION[''])) { echo "upload/".$_SESSION['logo'];}else{ echo "upload/4539883284_262x259.jpg"; } ?>" alt="Point of Sale" /></a>
...
<script type="text/javascript">
      (function() {
		...
		<p>Any Queries email to <a href="mailto:sridhar.librarymanagt@gmail.com?subject=Stock%20Management%20System">librarymanagt@gmail.com</a>.</p>
