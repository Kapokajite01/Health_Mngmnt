...
<body id="dt_example">
		...
		<form method="post" action="report_medicine1">
			...
			<h4 align="center">PURCHASED  MEDICINES ON&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $newdate; ?></strong><hr></hr></h4>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
as totalpurchase,medicine_mvt.action,medicine_mvt.bdate FROM medicine_mvt JOIN prodicts on medicine_mvt.id= prodicts.id WHERE medicine_mvt.action ='Purchase' AND bdate= '$date' GROUP BY bdate Desc ,product_name ORDER BY bdate, product_name"); 
...
<tr><th></th> <th><th></th> <th><th>Grand Total</th> <th><?php echo number_format((float)$grandsum,2);?></th> <th></th></tr>
			...
			<div>
				...
				<hr></hr>
<h5 align="center">Designed and Developed by  Digital Star</a> </h5><br>
				</div>
				</div>
		</div>		
	</body>
