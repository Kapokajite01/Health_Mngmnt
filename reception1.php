...
$checkrec = ("SELECT affiliate_number,names,lname,id,date FROM  patient where id ='$patientid'");
...
<body>
				...
				<tr><th><strong>Head House Holder's Number</th><th><strong><i><?php echo $affid;?></i></th></tr>
				...
				<input type="text" id="patientid" name="patientid" value ="<?php echo $nid;?>" style="display:none"><input type="text" id="lastdatecons" name="lastdatecons" value ="<?php echo $dt;?>"  style="display:none">
