...
<body>
  ...
  <div class="dddropdown">
    ...
    <div class="dddropdown-content">
      <a href="chart/statistics_all">Applications/CHART</a> 
	  <a href="chart/statistics_repayments">Reimbursement/CHART</a>
	  	 <a href="chart/statistics_denials">Applications/CHART</a>   </div>
  </div>
         ...
         <li class="nav-item">
          <a href="commercial_loan_inbox">  <div class="nav-link" >
              <span class="menu-title"><strong><font size="3px">Dashboard </font></strong></span>   
		  		  ...
		  		  <li class="nav-item">
          <a href="add_customer">  
              <span class="menu-title"><strong>Add New Customer </strong></span>   
           </a>
          </li>
		        <li class="nav-item">
          <a href="account_check"> 
              <span class="menu-title"><strong>Loan Application</strong></span>   
            </a>
          </li>
		  <li class="nav-item">
          <a href="Amortization_calcualtions">  
              <span class="menu-title"><strong>Amortization </strong></span>   
           </a>
          </li>
		<li class="nav-item">
          <a href="check_borrowers">  
              <span class="menu-title"><strong>Borrowers</strong></span>   
            </a>
          </li>
		   <li class="nav-item">
          <a href="check_loans"> 
              <span class="menu-title"><strong>Loans </strong></span>   
            </a>
          </li>
		  <li class="nav-item">
          <a href="repayments">  
              <span class="menu-title"><strong>Repayments</strong></span>   
            </a>
          </li>
		 
         <li class="nav-item">
          <a href="chart/satistics"> 
              <span><strong>Statistics </strong></span>   
           </a>
          </li>	 
         <li class="nav-item">
          <a href="check_Amortization"> 
