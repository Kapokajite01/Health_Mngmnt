...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id  WHERE insurance='MUTUELLE' and (sector = 'CYATO' and (cell ='MUTONGO' OR cell = 'MURAMBI' OR cell = 'RUGARI'))and MONTH(datecunsuption)= MONTH(CURDATE())and YEAR(datecunsuption)= YEAR(CURDATE()) GROUP BY pid,datecunsuption ORDER BY datecunsuption ,consid ");
...
$sumcopeymt=0;
$suminsured=0;
?>	 <form method="POST" action="zones1">
