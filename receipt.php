...
$getCid=("SELECT customer_id FROM prescription WHERE invoice_id='{$invNo}' ");
$getName=("SELECT customer_name FROM invoice WHERE invoice_id='{$invNo}' ");
$details1=mysqli_fetch_assoc($getName); 
$details=mysqli_fetch_assoc($getCid);

	
	$sqlP=("INSERT INTO receipts(reciptNo,customer_id,total,payType,serialno,served_by)
