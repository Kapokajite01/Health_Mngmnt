...
if (isset($_POST['bigbutton'])) {
	...
	if($destination =='Cashier'){
		$UPDATEstatus= "UPDATE consultation SET origine   = 'Consultation' WHERE patient_id = '$ID'"; 
mysqli_query($conn,$UPDATEstatus);
echo "<script>alert('Patient  Sent to Casshier')</script>";
echo "<script>window.location='nconsultation?affid=$affnumber&dtconsult=$dt&case=$cas';</script>";
	}
...
echo "<script>window.location='nconsultation1?affid=$affnumber&dtconsult=$dt&case=$cas';</script>";
	}
if($destination =='Maternite' or $destination =='CPN'or $destination =='Planning')
{
...
echo "<script>window.location='consultation?affid=$affnumber&dtconsult=$dt&case=$cas';</script>";	
