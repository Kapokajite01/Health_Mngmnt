...
as totmedicament,consomation.consommable,consomation.UPcons,consomation.Qcons,(consomation.UPcons*consomation.Qcons) as totconsommables,consomation.actemedicale,consomation.upacte,consomation.qtyacte,(consomation.upacte*consomation.qtyacte) AS totacte,consomation.examenmedicale,consomation.upexamen,consomation.qtyexamen,(consomation.qtyexamen*consomation.upexamen) as totexamens,consomation.datecunsuption FROM consomation JOIN  patient ON consomation.id=patient.id where insurance='MUTUELLE' and datecunsuption >= '$date' and datecunsuption <= '$date1' ORDER BY datecunsuption DESC,consid DESC");
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  ...
			  <form method="POST" action="mutuelle_u1.php">
                <td width="45"></td>
                <td width="393"><strong>DETAILED CONSUMPTIONS FOR MUTUELLE DE SATE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FROM:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $newdate; ?></td>
                <td><strong>&nbsp;&nbsp;&nbsp;TO :&nbsp;&nbsp;&nbsp;<?php echo $newdate1; ?></strong></td><td></td>
				<td></td>
				<td></td>
				<td></td>
				</form>
...
?>
				...
				<td><a href="modify?nid=<?php echo $row['consid']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
