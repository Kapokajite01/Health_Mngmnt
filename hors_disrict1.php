...
$result = ("SELECT patient.id as pid,patient.names,patient.lname,patient.carnet,patient.phtocopy,patient.transfert,patient.affectation,patient.insurance,patient.dob,patient.gender,patient.affiliate_number,patient.category,patient.sector,cell,district,
...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id  WHERE insurance='MUTUELLE' and district ='Kulu '  AND datecunsuption >= '$date' and datecunsuption <= '$date1'  GROUP BY pid,datecunsuption ORDER BY datecunsuption ,consid ");
 ...
 <hr></td>
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"></td>HORS DISTRICT PATIENTS </td>
