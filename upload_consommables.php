...
{ 
   ...
   $phpdate = date("Y-m-d", $unix_timestamp);
	...
	$sql = "INSERT INTO consommables (name_consommable,purchaseprice,unit_price,date)VALUES ('".$rowData[0][1]."', '".$rowData[0][2]."', '".$rowData[0][3]."',CURDATE())";
