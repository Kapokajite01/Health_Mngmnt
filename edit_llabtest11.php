...
$sql="update consomation_upload set up_exame = '$prodname', up_upexame ='$pcost',up_qtyexame = '$qty' where up_id='$id'";
($sql);
...
$id=$_POST['id'];
$date=$_POST['date'];
$result = ("SELECT up_pname,up_plname,up_afnumber,up_id,up_upexame,up_exame,up_upexame,up_qtyexame,datecunsuption 
FROM consomation_upload where up_exame!='' AND up_pid ='$id' and datecunsuption='$date'") 
                or die(mysql_error());
echo "<table border='1'>";
        ...
        while($row = mysqli_fetch_assoc( $result )) {
				...
				<td><a href="edit_llabtest1?consid=<?php echo $row['up_id']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
