...
<?php include'left_commercial.php';?>
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" ACTION="step_choice">
				<span class="contact100-form-title">
					LOAN INITIALIZATION<hr></hr>
				</span>
				<table><tr><td width="80%"><div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100"><strong> Enter Account Number *</strong></span>
				...
				</div></td><td width="20%">	<div align="center"><a href="javascript: void(0)" class="btn btn-success dropdown-toggle btn-sm"  aria-haspopup="true" aria-expanded="false" onclick="popup01('calculations')">Check Repayment &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td><tr></table>
