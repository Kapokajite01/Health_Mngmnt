...
<body id="dt_example">
		...
		<form method="post" action="report_medicine_auth1">
			
			<h4 align="center">AUTHORIZED MEDICINES IN &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date('F') ?> <?php echo date('Y') ?></strong><hr></hr></h4>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$num=0;
$grandsum=0;
$result = ("SELECT prodicts.	product_name,medicine_mvt.request_qty,medicine_mvt.authorize,medicine_mvt.actionb,medicine_mvt.bdate,medicine_mvt.adate FROM medicine_mvt JOIN prodicts on medicine_mvt.id= prodicts.id WHERE medicine_mvt.actionb ='Authorize' AND MONTH(bdate)= MONTH(CURDATE()) GROUP BY bdate Desc ,product_name ORDER BY bdate, product_name"); 
