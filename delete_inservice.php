...
$inservicedelete = " DELETE FROM  inservice_custom  WHERE service_id = '$ID ' ";
if ($conn->query($inservicedelete) === TRUE) {
echo "<script>alert('Successfully Deleted'); window.location='inservice_custom'</script>";
} else {
...
echo "<script>alert('Deleted Canceled'); window.location='inservice_custom'</script>";
