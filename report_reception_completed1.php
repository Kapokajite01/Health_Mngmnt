...
$result = ("SELECT patient.id as pid,patient.names,patient.lname,patient.carnet,patient.phtocopy,patient.transfert,patient.affectation,patient.insurance,patient.dob,patient.gender,patient.affiliate_number,patient.category,patient.null_tm,
...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id WHERE datecunsuption >='$mydate' and datecunsuption <='$mmydate' AND insurance ='MUTUELLE' GROUP BY pid,names,datecunsuption ORDER BY datecunsuption ASC,consid ASC ");
    ...
    <td align="center">
      ...
      <table width="595" border="0" cellspacing="0" cellpadding="0">
       ...
       <strong>MINISTRY OF HEALTH</strong><br />
                  ...
                  <strong>EASTERN PROVINCE</strong><br />
        ...
        <tr>
          ...
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="393"><strong>RECORDED  From:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $mydate1; ?>   To:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $mmydate1; ?></strong></td>
...
?>
	...
	<td><font color="black"><strong><a href="formPrint?affid=<?php echo urlencode($row['affiliate_number']); ?>&amp;affnumber=<?php echo urlencode($row['pid']); ?>&amp;affid=<?php echo urlencode($row['consid']); ?>&amp;fname=<?php echo urlencode($row['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;filenumber=<?php echo $tm; ?>"  target="_blank"><font color="black"><strong>File</font></strong></a></td>
