...
?>	
<!-- end side-menu -->
			<div class="content-module-main cf"><div align = "center"><h1>Import Tarif Consommables</h1><hr>
			
			<form id="uploadexcelfile" name="uploadexcelfile" action = 'upload_consommables.php' enctype="multipart/form-data" method="post" align="center">
