...
$result = ("SELECT patient.names,patient.lname,patient.insurance,patient.category,patient.policeno,patient.affiliate_number,patient.gender,patient.dob,patient.affiliate_names,patient.afilliate_lastname,patient.familycode,patient.cas,consomation.consultatiobn,consomation.datecunsuption,sum(consomation.upmedicamnet*consomation.qtymedicamnet)as totmedicament,sum(consomation.UPcons*consomation.Qcons) as totconsommables,
 ...
 FROM consomation JOIN  patient ON consomation.id=patient.id  WHERE ((datecunsuption >= '$date') AND (datecunsuption <= '$date1') AND (cas = 'Nouveau')) GROUP BY affiliate_number,datecunsuption ORDER BY datecunsuption");
...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="45">
		           <div  align="CENTER"><strong>NOUVEAUX CAS IN Kulu HEALTH CENTER</strong></div>
