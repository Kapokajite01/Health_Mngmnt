...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id  WHERE  cas = 'Nouveau' GROUP BY pid,datecunsuption ORDER BY datecunsuption ,consid ");
 ...
 <hr></td>
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"></td>Nouvaux cas  <strong><?php echo $month=date("F"); ?></strong></td>
                <td width="41"></td>
