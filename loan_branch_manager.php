...
<hr>   
 ...
 <button type="button" class="btn btn-success dropdown-toggle btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           ...
                           <div class="dropdown-menu">
                            ...
                            <button class="dropdown-item"  onClick=window.open("approve","Ratting","width=800,height=500,left=450,top=80,toolbar=0,status=0,"); accesskey="1">
                              <i class="fa fa-check text-success fa-fw"></i>Approve</button>
							    <button class="dropdown-item"  onClick=window.open("deny","Ratting","width=800,height=500,left=450,top=80,toolbar=0,status=0,"); accesskey="1">
                              <font color="red"><i class="fa fa-times"></i></font>&nbsp;Deny</button>
							    <button class="dropdown-item"  onClick=window.open("forward_to_credit_manager","Ratting","width=800,height=500,left=450,top=80,toolbar=0,status=0,"); accesskey="1">
                              <i class="fa fa-history fa-fw"></i>Return To Credit Manager</button>
