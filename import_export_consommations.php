...
?>	
<!-- end side-menu -->
			<div class="content-module-main cf"><div align = "center"><h1>Import Facture</h1><hr>
			
			<form id="uploadexcelfile" name="uploadexcelfile" action = 'upload.php' enctype="multipart/form-data" method="post" align="center">
<table style="width:100%;"> 
<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td></td><td></td><td><input type="text" placeholder="Origin" name="origine" required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
