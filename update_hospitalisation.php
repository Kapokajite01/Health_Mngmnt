...
$query1=("select * from hospitalisation where id='$id'");
$result = mysqli_query($conn, $query1);
while($query2 = mysqli_fetch_assoc($result)) {
	$hospiname = $query2['name_hospitalisation'];
	$hospiprice = $query2['unit_price'];
}
...
if(isset($_POST['update']))
{
	...
	$cost= $_POST['cost'];
$sql="update hospitalisation set name_hospitalisation = '$prodname', unit_price = '$cost' where id='$id'";
$updated  = mysqli_query($conn, $sql);
if($updated ){
$sql=("INSERT INTO logs(id,name,lname,phone,action,time)
VALUES('','$name','$lname','$tel','Updated Lab Test',now())");
header("location:manage_hospitalisation");
...
<table><tr><td> Hospitalisation </td><td><input type="text" name="prodname"value="<?php echo $hospiname; ?>"></td></tr>
<tr><td>Unit Cost</td><td> <input type="text" name="cost" value="<?php echo $hospiprice; ?>"></td></tr></table>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
