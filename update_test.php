...
$query1=("select * from examens where id='$id'");
$result = mysqli_query($conn, $query1);
while($query2 = mysqli_fetch_assoc($result)) {
$testname = $query2['name_examen'];	
$testprice = $query2['unit_price'];
}
...
if(isset($_POST['update']))
{
	...
	$cost= $_POST['cost'];
$sql="update examens set name_examen = '$prodname', unit_price = '$cost' where id='$id'";
...
<table><tr><td> Test Name </td><td><input type="text" name="prodname"value="<?php echo $testname; ?>"></td></tr>
<tr><td>Unit Cost</td><td> <input type="text" name="cost" value="<?php echo $testprice; ?>"></td></tr></table>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
