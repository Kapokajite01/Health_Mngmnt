...
$checkrec = ("SELECT id,affiliate_number,names,lname,date FROM patient where id ='$affid' and final='Consultation' ORDER BY id DESC LIMIT 1");
...
<body>
				...
				<form method="POST" action="nlaboratory">
				...
				<input type="text" id="patientid" name="patientid" value ="<?php echo $affid;?>" style="display:none"><input type="text" id="lastdatecons" name="lastdatecons" value ="<?php echo $dt;?>"  style="display:none">
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp; <ul id="country_list_id"></ul><input type="submit" name="search" value="SEARCH"><input type="text" name ="datelab" id="datesearch" size="30" placeholder="Enter Date " required aria-required='true' aria-describedby='name-format' autocomplete="off">
                </div></div><br><br>
				</form>
