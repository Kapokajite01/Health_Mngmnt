...
<body id="dt_example">
		...
		<form method="post" action="report_consumable1">
			...
			<h4 align="center">PURCHASED  CONSUMABLES IN HEALTH CENTER&nbsp;&nbsp;&nbsp;&nbsp; <?php echo date('F') ?> <?php echo date('Y') ?></strong><hr></hr></h4>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$result = ("SELECT consommables.	name_consommable,consomable_mvt.origine,sum(consomable_mvt.qtytin) as totqtyin,consomable_mvt.bying_price,sum(consomable_mvt.qtytin*consomable_mvt.bying_price) 
as totalpurchase,consomable_mvt.movment,consomable_mvt.bdate FROM consomable_mvt JOIN consommables on consomable_mvt.id= consommables.id WHERE consomable_mvt.movment ='Purchase' AND MONTH(bdate)= MONTH(CURDATE()) group by bdate,name_consommable order by bdate DESC , name_consommable"); 
...
?>
					<tr>
						...
						<td><?php echo $row['totqtyin'];?></td>
						<td><?php echo $row['bying_price'];?></td>
