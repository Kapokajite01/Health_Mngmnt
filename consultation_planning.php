...
echo "<script>
setTimeout(function () {
   window.location.href= 'family_palnning';
}, 1000);
</script>";
...
<form id="patient" name="patient" method="POST" action="saveplanning">
...
<table style=" margin-left: 30%;">
 ...
 {
 ?>
 <fieldset style="background:#e1eff2;width: 20%; " disabled><legend></strong><b>Diagnostic <font color="red"> Required !!!</font></b></strong></legend><textarea  name="diffenrenciel"  rows="2" cols="40"  onkeyup="countChar(this)"  required ><?php echo $examendifferenc;?></textarea></fieldset><font color="red"><strong><div id="charNum" style="margin-left: 55%"></div ></font><strong>Characters Remain</strong>
 ...
 {
 ?>
 <fieldset style="background:#e1eff2;width: 20%; "><legend></strong><b>Diagnostic <font color="red"> Required !!!</font></b></strong></legend><textarea  name="diffenrenciel"  rows="2" cols="40"  onkeyup="countChar(this)"  required ><?php echo $examendifferenc;?></textarea></fieldset><font color="red"><strong><div id="charNum" style="margin-left: 55%"></div ></font><strong>Characters Remain</strong>
