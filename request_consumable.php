...
<div class="side-menu fl">
			...
			<div class="content-module-main cf">
		<ul id="tabs" class="fl">
    <h1 align="center"><strong>Request Consumable For Distribution</strong></h1> 
<hr/>	
		...
		*/
        ...
        while($row = mysqli_fetch_assoc( $result )) {
				...
				echo '<td>' . $row['reamin'] . '</td>';
				echo '<td>' . $row['qntity'] . '</td>';
			?>
				
				<td><a href="request_cstock.php?id=<?php echo $row['id']?>"><img src="images/prescri.jpg" width="24" height="24" border="0" /><strong>REQUEST</strong></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
