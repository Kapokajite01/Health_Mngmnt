...
$result = ("SELECT id,names,affiliate_number,lname,carnet,phtocopy,transfert,consultatiom,insurance,date,gtal,copayment from patient where date >= '$date' AND date <= '$date1'  and paid='yes' ORDER BY id DESC");
$sumconsult=0;
$sumcarnet=0;
$sumphotocopy=0;
$sumtransfer=0;
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  ...
			  <form method="POST" action="report_reception1.php">
                <td width="45"></td>
                <td width="393"><strong>All PATIENT CARED &nbsp;&nbsp FROM :&nbsp;&nbsp <?php echo $newdate; ?>  &nbsp;&nbsp TO :&nbsp;&nbsp <?php echo $newdate1; ?></strong></td>
				</form>
              </tr>
          </table></td>
        </tr>
...
$sumcopeymt=$sumcopeymt+$row['copayment'];
