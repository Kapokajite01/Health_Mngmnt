...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id  WHERE insurance='MUTUELLE' AND cas = 'Ancien' AND datecunsuption >= '$date' AND datecunsuption <= '$date1'  GROUP BY pid,datecunsuption ORDER BY datecunsuption ,consid ");
