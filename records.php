  ...
  <tr>
    <td align="center">
      ...
      <strong>MINISTRY OF HEALTH</strong><br />
				  ...
				  <strong>RUHUHA HEALTH CENTER</strong><BR><BR> 
              </div>
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<?php
    $query1 = "SELECT * from users where role='Receptionist'";
 ...
 <select id="select" name="select">
      ...
      <?php
        while ($row1 = mysql_fetch_assoc($result1)) {
            echo '<option value="' . $row1['id'] . '">' . $row1['first_name'] .' &nbsp;&nbsp;&nbsp;'.$row1['last_name']. '</option>';
        }
      ?>

    </select><strong>&nbsp;&nbsp;
	<input id="uname" name="uname"  type="text"  required aria-required="true" aria-describedby="name-format" style="display:none">
	<input id="fname" name="fname" type="text"  required aria-required="true" aria-describedby="name-format" style="display:none">
	<input id="lname" name="lname"  type="text"  required aria-required="true" aria-describedby="name-format" style="display:none">
 <hr></td>
        </tr>
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"></td>
                <td width="393"><strong>All RECORDS ON:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $mydate1; ?> </strong></td>
