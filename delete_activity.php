...
$deleteactivity = " DELETE FROM  activity_custom  WHERE 	activity_id = '$ID ' ";

if ($conn->query($deleteactivity) === TRUE) {
echo "<script>alert('Successfully Deleted'); window.location='activity_custom'</script>";
} else {
...
echo "<script>alert('Deleted Canceled'); window.location='activity_custom'</script>";
