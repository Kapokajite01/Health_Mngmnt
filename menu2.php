	...
	<div id="top-bar">
		...
		<div class="page-full-width cf">
			...
			<ul id="nav" class="fl">
				...
				<li class="v-sep"><a href="#" class="round button dark menu-user image-left"><strong>Logged in as <?php echo $lname;?></strong></a>
					<ul>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
				<li><input type=button class="round button dark menu-user image-left" onClick=window.open("medicalacts","Ratting","width=1000,height=500,left=150,top=150,toolbar=0,status=0,"); value="MEDICAL ACTS"></li>
			<li><input type=button class="round button dark menu-user image-left" onClick=window.open("labtests","Ratting","width=1000,height=500,left=150,top=150,toolbar=0,status=0,"); value="LABORATORY TESTS"></li>				
					<li><input type=button class="round button dark menu-user image-left" onClick=window.open("search","Ratting","width=1500,height=900,left=150,top=80,toolbar=0,status=0,"); value="VEW PATIENT CONSUMPTIONS">&nbsp;&nbsp;&nbsp;</li>
		</ul> <!-- end tabs -->
