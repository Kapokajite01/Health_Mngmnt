...
<body id="dt_example">
		...
		<form method="post" action="use_consumable1">
			...
			<h4 align="center">UTILISATION OF MEDICINE IN HEALTH CENTER&nbsp;&nbsp;&nbsp;&nbsp; FROM &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date('F') ?> <?php echo $newdate; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TO <?php echo $newdate1?>&nbsp;&nbsp;&nbsp;</strong><hr></hr></h4>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
as totalsell,consomable_mvt.movment,consomable_mvt.bdate FROM consomable_mvt JOIN consommables on consomable_mvt.id= consommables.id WHERE consomable_mvt.movment ='OUT' AND bdate >='$date' AND bdate <='$date1' GROUP BY name_consommable ORDER BY bdate DESC,name_consommable"); 
