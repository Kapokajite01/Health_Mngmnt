...
<td><strong><a class="label label-sm label-success" href="denied_applications?8693d9a0b05c8569=<?php echo $ccrtoken;?>"<img src="images/mycommentt.jpg"  width="10" height="10" border="0" />View</a></td></tr>
	<?php
}}
