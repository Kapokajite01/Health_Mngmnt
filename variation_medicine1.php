...
medicine_mvt.action,medicine_mvt.bdate FROM medicine_mvt JOIN prodicts on medicine_mvt.id= prodicts.id WHERE (medicine_mvt.action='Purchase' or medicine_mvt.action='OUT') and bdate>= '$date' and bdate<= '$date1' and product_name='$prod' GROUP BY bdate Desc ,product_name ORDER BY bdate, action,product_name"); 
...
<hr>				<form method="post" action="">
			...
			<h4 align="center">STOCK VARIATION OF MEDICINES IN HEALTH CENTER IN&nbsp;&nbsp;&nbsp;&nbsp;</strong></h4>
			
		<h4 align="center">From&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $newdate ?>&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp; <?php echo $newdate1 ?>&nbsp;&nbsp;&nbsp; For&nbsp;&nbsp;&nbsp;<?php echo $prod; ?></strong></h4>
		<hr></hr>
