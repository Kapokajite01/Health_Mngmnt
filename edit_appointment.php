...
$apontID = $_GET['appontId'];
$selectApnt = mysqli_query($conn,"SELECT * FROM patient_reserv WHERE oatientReservID = '$apontID' ");
while($rowapt= mysqli_fetch_array($selectApnt))
{
$patientID = $rowapt['patientID'];	
$firstname = $rowapt['patientFname'];	
$patientLname = $rowapt['patientLname'];	
$gender   = $rowapt['gender'];
$telephone = $rowapt['telephone'];	
$province = $rowapt['province'];	
$district  = $rowapt['district'];	
$sector  = $rowapt['sector'];	
$cell  = $rowapt['cell'];	
$Dob  = $rowapt['Dob'];	
$insurance = $rowapt['insurance'];	
$department   = $rowapt['department'];	
$dateAppointment = $rowapt['dateAppointment'];	
$timeAppointmennt   = $rowapt['timeAppointmennt'];	
$doctorName    = $rowapt['doctorName'];	
$doctorID = $rowapt['doctid'];
$appointmentReason = $rowapt['appointmentReason'];	
}
...
<div class="wrapper col4">
  <div id="container">
   <form method="post" action="save_EDIT_appointment" name="frmappnt">
    <input type="text" name="recordId" value="<?php echo $apontID;?>" style="display:none" required  > 
	<br><br>
    <table style="width:70%" border="3">                
        <tr><td colspan="2"> <h1> <strong>Edit Appointment</strong></h1></td></tr>
          <td><strong>Number</strong></td>
          <td><input type="text"  name="patient_id"  autocomplete="off" required aria-required='true' aria-describedby='name-format' value="<?php echo $patientID;?>"  placeholder="Insurance Number"></td>
				   
        </tr>
		        <tr>
          <td><strong>Name</strong> </td>
          <td><input type="text"  name="patient_name" onkeyup="autocomplet()" autocomplete="off" required aria-required='true' aria-describedby='name-format'  value="<?php echo $firstname;?>"  placeholder="First Name" size="40%">
		     <input type="text"  name="patient_lname" onkeyup="autocomplet()" autocomplete="off" required aria-required='true' aria-describedby='name-format' value="<?php echo $patientLname;?>"  placeholder="Last Name" size="40%"></td>
        ...
        <option value="FEMALE">Female</option></select></td>
          ...
          <td><input type="text"  name="telephone" onkeyup="autocomplet()" autocomplete="off" required aria-required='true' aria-describedby='name-format'value="<?php echo $telephone;?>" placeholder="Telephone" size="30%"></td>
...
?> 
</select><input name="cellName" type="text"  id="txtContent3" style="display:none"  value="<?PHP if($cell){echo $cell;}?>" required/> </td>
...
<option value="<?php echo $Dob;?>" selected><?php echo $Dob;?></option>
		...
		<tr>
          ...
          <td>
		      <select name="selectScript" id="selectScript" onchange="SelectedInsurance(this);" required>
<?php
		  if($insurance)
		  {
        ...
        <tr>
		  ...
		  ?>
           <option value="">--Select Department--</option>
			...
			{
				?>
	<option value="<?php echo $rsdepartment['departmentid']?>"><?php echo $rsdepartment['departmentname'];?></option>
			
				
			<?php
			}
		  ?>
          </select><input type="text" name="departname" id="departname"  value="<?php echo $department;?>" style="display:none" required></td>
        ...
        <tr>
          ...
          <td><input type="time" name="apointmenttime" id="time" value="<?php echo $timeAppointmennt ; ?>" required/></td>
        </tr>
...
<?php			
		  ...
		  ?>
          </select><input type="text" name="doctorname" id="doctorname" style="display:none" value="<?php echo $doctorName;?>" required></td>
         
        </tr>
       
         <tr>
          <td><strong>Appointment reason</strong></td>
          <td><textarea name="appreason" id="appreason" style="width:300px;height:100px;" onkeyup="countChar(this)" required ><?php echo $appointmentReason; ?></textarea><font color="black"><strong><br><strong>Characters Remain <div id="charNum" style="margin-left: 15%"></div ></strong></font></td>
         
        </tr>		        
       
        <tr>
          <td colspan="2" align="center"><input type="submit" name="EDITappointment"  value="E D I T" style="border-radius: 4px;font-size: 16px;background-color: #4CAF50;"/></td>
        </tr>
      </tbody>
    </table>
