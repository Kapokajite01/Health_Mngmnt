...
$sql="update consomation set actemedicale = '', upacte='',qtyacte = '' where consid='$id'";
...
echo "<table border='1'>";
        ...
        while($row = mysqli_fetch_assoc( $resultselect )) {
				...
				<td><a href="delete_act1.php?consid=<?php echo $row['consid']?>"><img src="images/delete-icon.jpg" width="24" height="24" border="0" /></a></td>
