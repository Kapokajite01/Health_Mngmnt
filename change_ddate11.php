...
$sql="update consomation_upload set datecunsuption = '$date1' where up_pid='$myid' and datecunsuption='$date'";
...
echo "<table border='1'>";
         echo "<tr><th>Names</th><th>Branche</th></th><th>Date Consumption</th><th>Edit</th</tr>";
...
echo $myid;
				...
				<td><a href="edit_branche1?consid=<?php echo $row['consid']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
			<?php
		 } 
		 
		 
		 $result1 = ("SELECT up_pname,up_plname,up_afnumber,up_id,up_pid,up_consom_sonsultation,datecunsuption 
FROM consomation_upload WHERE up_id ='$id' and (datecunsuption='$date'OR datecunsuption='$date1') GROUP BY up_afnumber") 
                or die(mysql_error());
