		...
		if ($role == 'Commercial Officer')
         ...
         <li class="nav-item">
            <a href="commercial_loan_inbox">  <div class="nav-link" >
	         ...
	         <li class="nav-item">
            <a href="add_customer">  <div class="nav-link" >
              <span class="menu-title"><strong><font size="3px">Add New Customer </font></strong></span>   
            </div></a>
		 </li>'	 
		 ...
		 {echo ' 
         <li class="nav-item">
            <a href="q_loan_inbox">  <div class="nav-link" >
              <span class="menu-title"><strong><font size="3px">Dashboard </font></strong></span>   
            </div></a>
		 </li>';}
		 ...
		 {echo ' 
         <li class="nav-item">
            <a href="q_loan_headoffice">  <div class="nav-link" >
              <span class="menu-title"><strong><font size="3px">Dashboard </font></strong></span>   
            </div></a>
		 </li>';}
		 ...
		 ?>
		       <!-- <li class="nav-item">
          <a href="account_check_loanoffcer"> 
