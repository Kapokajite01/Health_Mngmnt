...
<body>
	...
	<!-- MAIN CONTENT -->
		...
		<ul id="tabs" class="fl">
				...
				<li><a href="manage_medicines" class="active-tab dashboard-tab">Manage Medicine</a></li>
		</ul> <!-- end tabs -->
...
<div class="side-menu fl">
			...
			<div class="content-module-main cf">
		<ul id="tabs" class="fl">
    <h1 align="center">Manage Medicine</h1> 
<hr/>	
...
$resultselect = mysqli_query($conn, $result);
        ...
        echo "<table border='1'>";
         echo "<tr><th>No</th><th>Name</th><th>Purchase UP</th><th>Selling UP</th><th>Update</th><th>Delete </th></tr>";
        ...
        while($row = mysqli_fetch_assoc( $resultselect )) {
				...
				<td><a href="update_stock?id=<?php echo $row['id']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
				<td><a href="delete_stock?id=<?php echo $row['id']?>"><img src="images/delete-icon.jpg" width="24" height="24" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
        ...
        <div id="content_2" class="content">  
		 ...
		 <?php echo $message;
			  echo $message1;
			  ?>
			<form name="myform" onsubmit="return validateForm(this);" action="manage_medicines" method="post" >
			<table width="420" height="106" border="0" >	
				<tr><td align="center"><input name="cons_name" type="text" style="width:170px" placeholder="Drug Name" required="required" id="drug_name"/></td></tr>
				<tr><td align="center"><input name="pcost" type="text" style="width:170px" placeholder="Unit Selling Price" required="required" id="cost" /></td></tr>  
