...
$result = ("SELECT patient.id as pid,patient.names,patient.lname,patient.carnet,patient.phtocopy,patient.transfert,patient.affectation,patient.insurance,patient.dob,patient.gender,patient.affiliate_number,patient.category,patient.sector,cell,
...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id  WHERE insurance='MUTUELLE' AND hospitalization = '' and MONTH(datecunsuption)= MONTH(CURDATE())and YEAR(datecunsuption)= YEAR(CURDATE()) GROUP BY pid,datecunsuption ORDER BY datecunsuption ,consid ");
...
$sumcopeymt=0;
$suminsured=0;
?>	 <form method="POST" action="out_patients1">
 ...
 <hr></td>
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"></td>ZONE PATIENTS IN THE MONTH OF <strong><?php echo $month=date("F"); ?></strong></td>
                <td width="41"></td>
