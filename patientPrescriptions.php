...
<strong>- Identification</strong>
 ...
 <input class="radio" id="one" name="group" type="radio" checked>
  ...
  <div class="tabs" style="margin-left:35%">
    <label class="tab" id="one-tab" for="one"><h1><strong>Medicines  </strong></h1></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="tab" id="two-tab" for="two"><h1><strong>Services  </strong></h1></label>
  </div>
   <div class="panels">
...
<form method="POST" action="">
	...
	<table  border="0" style="margin: 25px;width:80%">
      <tbody>
        ...
        <tr>
          <td>Usage</td>
          <td><textarea name="textarea" id="textarea" cols="25" rows="2" required></textarea></td>
        </tr>
        <tr>
          <td colspan="2" align="center"><input type="submit" name="submit" id="submit" value="Add Medicine "  style="border-radius: 4px;font-size: 36px;background-color: #4CAF50;" /> </td>
        </tr>
      </tbody>
    </table>
    </p>
	...
	<table  border="0" style="margin: 25px;width:80%">
      <tbody>
        ...
        <tr>
          ...
          <td width="66%">
		  <select name="medicineid" id="medicineid" onchange="loadservice(this.value)" required>
		  <option value="">Select Service</option>
		  <?php
		$sqlacte ="SELECT * FROM actes order by name_acte";
		$qsqlacte= mysqli_query($con,$sqlacte);
		while($rsacte = mysqli_fetch_array($qsqlacte))
		{
			echo "<option value='$rsacte[id]'>$rsacte[name_acte]</option>";
		}
		?>
		  </select>
		  </td>
        ...
        <tr>
          <td>Cost</td>
          <td><input type="text" name="actcost" id="actcost" size="5px" readonly required/></td>
        </tr>
        <tr>
          <td>Unit</td>
          <td><input type="number" min="1" name="actunit" id="actunit" size="5px" onkeyup="calctotalactcost(actcost.value,this.value)" onchange="calctotalactcost(actcost.value,this.value)" required /></td>
        </tr>
        <tr>
          <td>Total Cost</td>
          <td><input type="text" name="acttotcost" id="acttotcost" size="5px" readonly  required/></td>
        </tr>
        <tr>
          <td>Usage</td>
          <td><textarea name="textarea" id="textarea" cols="25" rows="2" required></textarea></td>
        ...
        <tr>
          <td colspan="2" align="center"><input type="submit" name="submit" id="submit" value="Add Service "  style="border-radius: 4px;font-size: 36px;background-color: #4CAF50;" /> </td>
        </tr>
      </tbody>
    </table>
    </p>
