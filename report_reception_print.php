...
<body>
 ...
 <table   class='blueTable'>
				<tr><td  align="right"><br><div class="input_container">
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp; <ul id="country_list_id"></ul></div> <input type="text" name="datesearch" id="datesearch" required aria-required='true' aria-describedby='name-format' placeholder="Date Recorded" autocomplete="off"/></td>
                </tr><tr><td align="center"><input type="submit" id="bigbutton" name="submit" value="Search"></td>
                </tr></table>
				</form>
				<br><br>
         <?php  
	   if(isset($_POST['submit'])){
	$insunjumber = $_POST['country_id'];
	$date= $_POST['datesearch'];
	
	$pstients = "SELECT id,affiliate_number,names,lname,dob FROM patient WHERE affiliate_number = '$insunjumber'";
	$resultpatients= mysqli_query($conn, $pstients);
if ($resultpatients->num_rows > 0) {
	echo "<table    class='blueTable'>";
	while($rowval = mysqli_fetch_assoc($resultpatients)) {
	...
	<td><a href = "report_reception_print1?affid=<?php echo urlencode($rowval['id']); ?>&amp;CDATE=<?php echo $date; ?>">Seelect</a></td></tr>
	<?php
