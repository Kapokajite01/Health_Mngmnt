...
$dt=$_POST['date'];
$number=$_POST['searc'];
$result = ("SELECT patient.names,patient.lname,patient.affiliate_number,consomation.consid,consomation.id,consomation.consultatiobn,consomation.datecunsuption 
...
echo "<table border='1'>";
         echo "<tr><th>Names</th><th>Consultation</th><th>Date Consumption</th><th>Edit</th</tr>";
      ...
      while($row = mysqli_fetch_assoc( $resultselect )) {
				...
				<td><a href="edit_consultation1.php?consid=<?php echo $row['consid']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
			<?php
		 } 
        $result1 = ("SELECT up_pname,up_plname,up_afnumber,up_id,up_pid,up_consom_sonsultation,datecunsuption 
FROM consomation_upload WHERE up_afnumber LIKE '%$number%' and datecunsuption ='$dt' ") 
                or die(mysql_error());
