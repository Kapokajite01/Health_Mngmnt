...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id  WHERE insurance='MUTUELLE' AND cas = 'Nouveau' AND datecunsuption >= '$date' AND datecunsuption <= '$date1'  GROUP BY pid,datecunsuption ORDER BY datecunsuption ,consid ");
...
$sumcopeymt=0;
$suminsured=0;
?>	 <form method="POST" action="nouvaux_cas1">
 ...
 <hr></td>
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"></td>Nouvaux cas</td>
                <td width="41"> FROM :&nbsp;&nbsp <?php echo $newdate; ?></td>
                <td width="116">   TO :&nbsp;&nbsp <?php echo $newdate1; ?></td>
				<td width="41"></td>
				<td width="41"></td>
</form>
              </tr>
