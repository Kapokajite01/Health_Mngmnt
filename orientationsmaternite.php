...
$cas = $_POST['cas'];
	...
	if($destination =='Cashier'){
		$UPDATEstatus= "UPDATE consultation SET origine   = 'Maternite' WHERE patient_id = '$ID'"; 
mysqli_query($conn,$UPDATEstatus);
echo "<script>alert('Patient  Sent to Maternite')</script>";
echo "<script>window.location='nmaternite?affid=$affnumber&dtconsult=$dt&case=$cas';</script>";
	}
...
echo "<script>window.location='nmaternite1?affid=$affnumber&dtconsult=$dt&case=$cas';</script>";
	...
	if($destination =='Consultation' or $destination =='CPN'or $destination =='Planning')
{
...
echo "<script>window.location='maternite?affid=$affnumber&dtconsult=$dt&case=$cas';</script>";	
