...
$resultdetails = $conn_db->query($details);
if ($resultdetails->num_rows > 0) {
while($rowdet = $resultdetails->fetch_assoc()) {
  $accountnumber = $rowdet['loan_account'];
...
<tr><td style=" text-indent: 30%;"><span><strong>Names  :&nbsp;&nbsp;<?php echo $firstname;?>&nbsp;&nbsp;<?php echo $lastname;?></strong></td><tr>
<tr><td style=" text-indent: 30%;"><span><strong>Account Number :</span>&nbsp;&nbsp;<?php echo $accountnumber ;?></strong></td><tr>
<tr><td style=" text-indent: 30%;"><span><strong>ID Number :</span>&nbsp;&nbsp;<?php echo $idnumber;?></strong></td><tr>
</table><br>
