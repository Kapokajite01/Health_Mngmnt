...
$insert3 = ("INSERT INTO verification (consid,id,consultatiobn,medicament,upmedicamnet,qtymedicamnet,consommable,UPcons,Qcons,actemedicale,upacte,qtyacte,examenmedicale,upexamen,qtyexamen,datecunsuption,comments,date_comment)VALUES('$consid','$pid','$consu','$medicament','$pricemed','$qtymed','$consomable','$pricecons','$qtycons','$acte','$priceacte','$qtyacte','$lab','$pricelab','$qtylab','$date','$comment',CURDATE())");
...
as totmedicament,consomation.consommable,consomation.UPcons,consomation.Qcons,(consomation.UPcons*consomation.Qcons) as totconsommables,consomation.actemedicale,consomation.upacte,consomation.qtyacte,(consomation.upacte*consomation.qtyacte) AS totacte,consomation.examenmedicale,consomation.upexamen,consomation.qtyexamen,(consomation.qtyexamen*consomation.upexamen) as totexamens,consomation.datecunsuption FROM consomation JOIN  patient ON consomation.id=patient.id 
where insurance='MUTUELLE' and MONTH(datecunsuption)= MONTH(CURDATE()) AND comments ='' AND consid< $conso ORDER BY datecunsuption DESC,consid DESC");
      ...
      <table width="595" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
			  <form method="POST" action="verification_mutuelle1.php">
                <td width="45"></td>
                <td width="393"><strong>DETAILED CONSUMPTIONS FOR MUTUELLE DE SATE  FOR:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo date('F') ?> <?php echo date('Y') ?></strong></td>
...
?>
				...
				<td><?php $current = $row['pid'];
						...
						<td><?php 
						if($row['totmedicament']==0){
							echo "";
						}
						else{echo '<strong>'.number_format((float)$row['totmedicament'], 1).'</strong>';}?></td>
				<td><a href="modify001?id=<?php echo $row['consid']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
