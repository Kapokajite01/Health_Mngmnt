...
$mydate1=date("d/m/Y", strtotime($today));

IF($ROLE =='Mutuelle'){

$result = ("SELECT patient.id as pid,patient.names,patient.lname,patient.carnet,patient.phtocopy,patient.transfert,patient.affectation,patient.insurance,patient.dob,patient.gender,patient.affiliate_number,category,
...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id WHERE datecunsuption='$today' GROUP BY pid,datecunsuption ORDER BY datecunsuption DESC,consid DESC");
...
?>	 <form method="POST" action="report_reception_completed1">
        ...
        <tr>
          ...
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="45"><strong>RECORDED BY &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $myuname;?> &nbsp;&nbsp;&nbsp;&nbsp; ON:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $mydate1; ?> </strong></td>

                <td width="393"></td>

                <td width="41"><input type="text" name="datesearch" id="datesearch" required aria-required='true' aria-describedby='name-format' placeholder="Start"  autocomplete="off"/> </td><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="datesearch1" id="datesearch1" placeholder="End " required aria-required='true' aria-describedby='name-format'placeholder="End Date" autocomplete="off"></td>
...
if((($ass == 'MUTUELLE') and ($categ == 1)) OR ($TMOD=='Yes')){
