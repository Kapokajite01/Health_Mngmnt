...
<div id="top-bar">
		...
		<div class="page-full-width cf" >
			...
			<ul id="nav" class="fl" >
				...
				<li class="v-sep"><a href="maternite" class="round button dark menu-user image-left"><strong>Logged in as &nbsp;&nbsp;&nbsp;[<?php echo $name.'&nbsp;&nbsp;&nbsp;'.$lname;?>]</strong></a>
					<ul>
	...
	<li class="v-sep"><a href="maternite" class="round button dark menu-user image-left"> <strong>Consultation   Report </strong></a>
<ul>
		<li class="v-sep"><a href="maternite" class=" stock-tab" onClick=window.open("consultationReport","Ratting","width=1200,height=1800,left=200,scrollbars=yes,toolbar=0,status=0,"); value="MEDICINES"><strong>Consultation report </strong></a></li>
					</ul> 
				


				</li>
					<li class="v-sep"><a href="maternite" class="round button dark menu-user image-left"><strong>Incomes Report</strong></a>
					</li>
...
?>
  <div class="tabs">
    <label class="tab" id="one-tab" for="one"><h1><strong>Maternite [  ] </strong></h1></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label class="tab" id="two-tab" for="two"><h1><strong>Appointment [  ]</strong></h1></label>
  </div>
...
function my_encrypt($data, $key) {
	...
	if($branch != ''){
	?>
	<td><a href = "labmaternite?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></td>
	<?php
	}
	else{
		
	?>
	<td><a href = "labmaternite?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
	<?php
	}
	?>
	</tr>
<?php
	...
	{
	?>
	<td><strong><a href = "orientationsmaternite?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"> Select</a></td>
	<?php
	}
	else
	{
		...
		{
		?>
		<td><strong><a href = "orientationsMatRed?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></td>
	...
	<?php
		...
		{
		?>
		<td><strong><a href = "nmaternite1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></a></td>
	
	<?php
		}
		else if($origine == 'Maternite')
		{
		?>
		<td><strong><a href = "nmaternite?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
	...
	<?php
		...
		if($branch ==''){
			?>
		<td><strong><a href = "nmaternite1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="black"><strong>Select</font></a></td>
...
<td><strong><a href = "nmaternite1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
<?php		
...
<?php
	...
	<td><strong><?php echo $newDate = date("d/m/Y", strtotime($rowval['date']));?></td>
	<td>
	<strong><a href = "consultation_maternite?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a>
...
?><tr><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr>
	...
	ELSE{
				$msg = "<h1 align='center'><font color='red'> No Patient in Maternity</font></h1>";
