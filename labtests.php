...
$testtemp = ("select * from consom_labs WHERE patient_id   = '$patient_id'  AND time_test  = '$mydate' ");
...
while ($rowmed = mysqli_fetch_assoc($temtest)) {
	...
	<tr>
	<td><?php echo $i;?></td>
	<td style="width:80%"><?php echo $rowmed['examen'];?></td>
...
{
if($role == "Maternite"){
$UPDATEstatus= "UPDATE consultation SET status  = 'Laboratoire',origine = 'Maternite' WHERE patient_id   ='$patient_id' and time_reception = '$mydate'"; 
mysqli_query($conn,$UPDATEstatus);
}
if($role == "Consultation"){
$UPDATEstatus= "UPDATE consultation SET status  = 'Laboratoire',origine = 'Consultation' WHERE patient_id   ='$patient_id' and time_reception = '$mydate'"; 
mysqli_query($conn,$UPDATEstatus);
}	
if($role == "Family_planning"){
$UPDATEstatus= "UPDATE consultation SET status  = 'Laboratoire',origine = 'Planning' WHERE  patient_id   ='$patient_id' and time_reception = '$mydate'"; 
mysqli_query($conn,$UPDATEstatus);
}	
$_SESSION['labsaved'] = "Yes";	
