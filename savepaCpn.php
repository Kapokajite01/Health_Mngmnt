...
$insert = ("INSERT INTO consomation_consom (id,consultatiobn,medicament,upmedicamnet,qtymedicamnet,consommable,UPcons,Qcons,actemedicale,upacte,qtyacte,examenmedicale,upexamen,qtyexamen,hospitalization,uphospitalizations,qtyhoapitalization,FdtHospitalisation,LdtHospitalisation,ambullance,upambullance,qtyambullance,datecunsuption,user,postedesante)
      VALUES('$pid','$consultation','$medicments[$ih]', '$pricemecamen[$ih]','$qtymedicamen[$ih]','$consomables[$ih]','$pricecosnmble[$ih]','$qtyconsmble[$ih]','$actemedic[$ih]', '$pricemedacte[$ih]','$qtymedacte[$ih]','$ex7','$upex7','$qex7','$hosptlstion[$ih]','$pricehosp[$ih]','$qtyhosp[$ih]','$firstDate[$ih]','$lastDate[$ih]','$amblnce[$ih]','$amtkm[$ih]','$ambukm[$ih]','$myndate','$userid','$postedesante')");
...
$insertAmbul = ("INSERT INTO consomation_consom (id,consultatiobn,ambullance,upambullance,qtyambullance,datecunsuption,user,postedesante)
      VALUES('$pid','$consultation','$amblnce','$amtkm','$ambukm','$myndate','$userid','$postedesante')");
...
echo "<script>window.location='cprenatale';</script>";
	...
	$consult = ("INSERT INTO consomation_consom (id,consultatiobn,ambullance,upambullance,qtyambullance,datecunsuption,user,postedesante)VALUES('$pid','$consultation','$amblnce','$amtkm','$ambukm','$myndate','$userid','$postedesante')");
