		...
		<div class="page-full-width cf">
			...
			<ul id="nav" class="fl">
				...
				<li class="v-sep"><a href="" class="round button dark menu-user image-left"> <strong>Logged In As &nbsp;&nbsp;&nbsp;<?php echo $myusername;?></strong></a>
					...
					<li class="v-sep"><a href="m_reception" class="round button dark menu-user image-left"> <strong>New Patient</strong></a>
...
<ul>
		<li class="v-sep"><a href="" class=" stock-tab" onClick=window.open("search","Ratting","width=1800,height=1800,scrollbars=yes,toolbar=0,status=0,"); value="MEDICINES"><strong>Patient </strong></a></li>
					</ul> 
