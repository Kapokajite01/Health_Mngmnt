...
$result = ("SELECT  DISTINCT names,lname,id,gender,dob,category,province,district,sector,affiliate_number,affiliate_names,
afilliate_lastname,affectation,insurance,familycode,consultatiom,date from patient WHERE affiliate_number  = '$afnumber'  ORDER BY ID DESC"); 
...
echo "<table class='blueTable'>";
		 ...
		 <th>affectation</th><th>Insurance</th><th>Family code</th><th>Date Reception</th><th>Edit</th</tr>";
        while($row = mysqli_fetch_assoc( $resultselect )) {
				...
				<td><a href="edit_patient_reception?id=<?php echo $row['id']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
			<?php
		 } 
        echo "</tr></table>";
}
