...
$sql="UPDATE users SET first_name='$fname', last_name='$lname',phone='$phone',username='$username', password='$pas' WHERE username='$username'";
...
<hr/>	
    <div class="tabbed_area">  
		...
		<?php echo $message1;?>
          <form name="myform" onsubmit="return validateForm(this);" action="update_pharmacist" method="post" >
