...
<div id="top-bar">
		...
		<div class="page-full-width cf" >
			...
			<ul id="nav" class="fl" >
				...
				<li class="v-sep"><a href="cprenatale" class="round button dark menu-user image-left"><strong>Logged in as &nbsp;&nbsp;&nbsp;[<?php echo $name.'&nbsp;&nbsp;&nbsp;'.$lname;?>]</strong></a>
					<ul>
	...
	<li class="v-sep"><a href="cprenatale" class="round button dark menu-user image-left"> <strong>Consultation   Report </strong></a>
<ul>
		<li class="v-sep"><a href="cprenatale" class=" stock-tab" onClick=window.open("consultationReport","Ratting","width=1200,height=1800,left=200,scrollbars=yes,toolbar=0,status=0,"); value="MEDICINES"><strong>Consultation report </strong></a></li>
					</ul> 
				


				</li>
					<li class="v-sep"><a href="cprenatale" class="round button dark menu-user image-left"><strong>Incomes Report</strong></a>
					</li>
...
$sqlresult = ("select id,affiliate_number,names,lname,affiliate_names,afilliate_lastname,dob,date,patient_id,status,cas,time_reception,origine,branch from patient JOIN consultation ON consultation.patient_id = patient.id WHERE affiliate_number = '$insurancenmber'   and (status ='CPN'  or  origine ='CPN')  GROUP BY patient_id order by  date,consultation_id ");
  }
  else{
	$sqlresult = ("select id,affiliate_number,names,lname,affiliate_names,afilliate_lastname,dob,date,patient_id,status,cas,time_reception,origine,branch from patient JOIN consultation ON consultation.patient_id = patient.id   and (status ='CPN'  or  origine ='CPN')  GROUP BY patient_id order by date,consultation_id ");
    }
...
?>
  <div class="tabs">
    <label class="tab" id="one-tab" for="one"><h1><strong>CPN [ <?php echo $MYCOSNULTA;?> ] </strong></h1></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
function my_encrypt($data, $key) {
	...
	if($branch != ''){
	?>
	<td><a href = "labCpn?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></td>
	<?php
	}
	else{
		
	?>
	<td><a href = "labCpn?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
	<?php
	}
	?>
	</tr>
<?php
	...
	{
	?>
	<td><strong><a href = "orientationCpn?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"> Select</a></td>
	<?php
	}
	else
	{
		...
		{
		?>
		<td><strong><a href = "orientationsCPNRed?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></td>
	...
	<?php
		...
		{
		?>
		<td><strong><a href = "nCPN1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="#CD5C5C"><strong>Redirected</font></a></a></td>
	...
	<?php
		...
		{
		?>
		<td><strong><a href = "nCPN?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
	...
	<?php
		...
		if($branch ==''){
			?>
		<td><strong><a href = "nCPN1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>"><font color="black"><strong>Select</font></a></td>
...
<td><strong><a href = "nCPN1?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a></td>
<?php		
...
<?php
	...
	<td><strong><?php echo $newDate = date("d/m/Y", strtotime($rowval['date']));?></td>
	<td>
	<strong><a href = "consultation_CPN?affid=<?php echo urlencode($affnumber); ?>&amp;fname=<?php echo urlencode($rowval['names']); ?>&amp;lastname=<?php echo urlencode($rowval['lname']); ?>&amp;dtconsult=<?php echo urlencode($rowval['time_reception']); ?>">Select</a>
