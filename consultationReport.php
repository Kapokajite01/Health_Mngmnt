...
<div class="row" > 
		...
		<thead  >
													...
													$query=mysqli_query($conn,"Select names,lname,affiliate_number,insurance,gender,dob,datecunsuption,comment FROM consomation_consom  join patient ON patient.id = consomation_consom.id join doctor_comments ON doctor_comments.patient_id = patient.id  where MONTH(datecunsuption)= MONTH(CURDATE())and YEAR(datecunsuption)= YEAR(CURDATE())GROUP BY patient.id ");
													if ($query->num_rows > 0) {
													...
													<tr> 
														...
														<td style ="width:2000px;"><font color="black" ><p><?php echo $row['comment'];?></p></td>
