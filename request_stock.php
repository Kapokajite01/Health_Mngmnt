...
<tr><td><strong>Request </strong></td><td><input size="50px" type="text" name="request" id="request" required aria-required="true" aria-describedby="name-format" autofocus  autocomplete="off"  ></td></tr>
