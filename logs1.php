...
<div id="tabbed_box" class="tabbed_box">  
    <h4 align="center"><strong>Logs From  <?php echo $dt;?> To <?php echo $dt1;?> </strong></h4> 
<hr/>	
<form method="POST" action="logs1">
    <div class="tabbed_area">            
       ...
       $result = ("SELECT * FROM logs where time >='$dt' and time<='$dt1' order by id DESC") 
                or die(mysql_error());
