...
$result = ("SELECT patient.id as pid,patient.names,patient.affiliate_names,patient.lname,patient.afilliate_lastname,patient.familycode,patient.affectation,patient.insurance,patient.dob,patient.category,patient.gender,
...
as totmedicament,consomation.consommable,consomation.UPcons,consomation.Qcons,sum(consomation.UPcons*consomation.Qcons) as totconsommables,consomation.actemedicale,consomation.upacte,consomation.qtyacte,
sum(consomation.upacte*consomation.qtyacte) AS totacte,consomation.examenmedicale,consomation.upexamen,consomation.qtyexamen,sum(consomation.qtyexamen*consomation.upexamen) as totexamens,
consomation.datecunsuption FROM consomation JOIN  patient ON consomation.id=patient.id where insurance='MUTUELLE' and datecunsuption >= '$date' and datecunsuption <= '$date1' GROUP BY pid,datecunsuption ORDER BY datecunsuption DESC,consid DESC");
      ...
      <table width="595" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"></td>
                <td width="393"><strong>MUTUELLE DE SANTE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FROM:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $newdate; ?></td>
                <td><strong>&nbsp;&nbsp;&nbsp;TO :&nbsp;&nbsp;&nbsp;<?php echo $newdate1; ?></strong></td>
				<td></td>
				<td></td>
				<td></td>
	            </tr>
