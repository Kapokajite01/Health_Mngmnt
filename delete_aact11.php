...
$sql="update consomation_upload set up_acte = '', up_upacte='',up_qtyacte = '' where up_id='$id'";
($sql);
...
echo "<table border='1'>";
        ...
        while($row = mysqli_fetch_assoc( $result )) {
				...
				<td><a href="delete_aact1.php?consid=<?php echo $row['up_id']?>"><img src="images/delete-icon.jpg" width="24" height="24" border="0" /></a></td>
