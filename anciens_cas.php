...
<?php
$tm=0;
$mydate=$_POST['datesearch'];
$mmydate=$_POST['datesearch1'];
$mydate1=date("d/m/Y", strtotime($mydate));
$mmydate1=date("d/m/Y", strtotime($mmydate));

$result = ("SELECT patient.id as pid,patient.names,patient.lname,patient.carnet,patient.phtocopy,patient.transfert,patient.affectation,patient.insurance,patient.dob,patient.gender,patient.affiliate_number,patient.category,district,patient.sector,cell,
consomation.consid,consomation.consultatiobn,consomation.medicament,consomation.upmedicamnet,consomation.qtymedicamnet,sum(consomation.upmedicamnet*consomation.qtymedicamnet) as totmedicament,cas,
consomation.consommable,consomation.UPcons,consomation.Qcons,sum(consomation.UPcons*consomation.Qcons) as totconsommables,hospitalization,consomation.actemedicale,consomation.upacte,consomation.qtyacte,sum(consomation.upacte*consomation.qtyacte) AS totacte,
...
consomation.datecunsuption,consomation.user FROM consomation JOIN  patient ON consomation.id=patient.id  WHERE insurance='MUTUELLE' AND cas = 'Ancien' and MONTH(datecunsuption)= MONTH(CURDATE())and YEAR(datecunsuption)= YEAR(CURDATE()) GROUP BY pid,datecunsuption ORDER BY datecunsuption ,consid ");
...
$sumcopeymt=0;
$suminsured=0;
?>	 <form method="POST" action="ancien_cas1">
 ...
 <hr></td>
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"></td>Ancien cas  <strong><?php echo $month=date("F"); ?></strong></td>
                <td width="41"></td>
