...
if (isset($_POST['bigbutton'])) {
	...
	if($destination =='Cashier'){
		$UPDATEstatus= "UPDATE consultation SET origine = 'Consultation',branch = 'RedAndAdded'  WHERE patient_id = '$ID'"; 
mysqli_query($conn,$UPDATEstatus);
echo "<script>alert('Patient  Sent to Casshier')</script>";
echo "<script>window.location='nconsultationRed?affid=$affnumber&dtconsult=$dt&case=$cas';</script>";
	}
