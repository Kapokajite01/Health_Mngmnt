...
VALUES('$sname','$cost')");
if($sql>0) {header("location:http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/lab_test");
}else{
...
<div class="side-menu fl">
				...
				<h3>Quick Links</h3>
				<ul>
					<li><a href="stock">Add/Edit Mdicine</a></li>
...
?> 
        ...
        <div id="content_2" class="content">  
		 ...
		 <?php echo $message;
			  echo $message1;
			  ?>
			<form name="myform" onsubmit="return validateForm(this);" action="lab_test" method="post" >
