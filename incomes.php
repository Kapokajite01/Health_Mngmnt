        ...
        <tr>
          ...
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  ...
			  <form method="POST" action="incomes1">
                ...
                <td width="393"><strong>OTHER INCOMES AND TICKET MODERATEUR IN &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date('F') ?> <?php echo date('Y') ?></strong></td>
...
?>
		...
		<td><?php echo $row['names'].' '.$row['lname'];?></td>
						...
						$fichecons =20;
						echo $fichecons;
						$ficheconsult = $ficheconsult + $fichecons; 
						...
						?></td>						<td><strong><?php 
						$total[$ij]=$thistm[$ij]+$fichetra[$ij]+$fichecons+$photocop[$ij];
