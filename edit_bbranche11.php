...
$sql="update consomation_upload set postedesante = '$prodname' where up_pid='$myid'and datecunsuption='$date'";
($sql);
...
$id=$_POST['id'];
$date=$_POST['date'];
$result = ("SELECT up_pname,up_plname,up_afnumber,up_id,up_pid,postedesante,datecunsuption 
FROM consomation_upload where up_pid='$id' and datecunsuption='$date' GROUP BY up_afnumber") 
                or die(mysql_error());
echo "<table border='1'>";
...
echo $myid;
				...
				<td><a href="edit_bbranche1?consid=<?php echo $row['up_id']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
			<?php
		 } 
