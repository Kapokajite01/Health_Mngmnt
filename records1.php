    ...
    <td align="center">
      ...
      <table width="595" border="0" cellspacing="0" cellpadding="0">
        ...
        <strong>MINISTRY OF HEALTH</strong><br />
				  ...
				  <strong>RUHUHA HEALTH CENTER</strong><BR><BR>               </div>
		  <hr></td>
        </tr>
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="45"></td>
                <td width="393"><strong>Recorded By &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $fnames.'&nbsp;&nbsp;&nbsp;'.$lnames;?> &nbsp;&nbsp;&nbsp;&nbsp; On:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $mydate1; ?> </strong></td>
              </tr>
          </table></td>
        </tr>
        <tr>
