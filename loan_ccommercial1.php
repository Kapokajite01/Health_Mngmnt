...
<!--===============================================================================================-->
	...
	<body class="no-skin" oncontextmenu="return false" onload="summed1();">
...
$key = 'bRuD5WYw5wd0rdHR9yLlM6wt2vteuiniQBqE70nAuhU=';
 $encrypted =$_GET['eb803838609d2516b'];
...
<table class="blueTable" align="center" style="background-color:black">
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>Account Number :&nbsp;&nbsp;</i><?php echo $account;?></font></strong></td><tr>
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>Names  :&nbsp;&nbsp;</i><?php echo $firstname;?>&nbsp;&nbsp;<?php echo $lastname;?></strong></td><tr>
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>ID Number :&nbsp;&nbsp;</i><?php echo $idnumber;?></strong></td><tr>
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>Address :&nbsp;&nbsp;</i><?php echo $province .'&nbsp;/&nbsp;'.$district.'&nbsp;/&nbsp;'.$sector.'&nbsp;/&nbsp;'.$cell.'&nbsp;/&nbsp;'.$village;?></strong></td><tr>
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>Loan Amount :&nbsp;&nbsp;</i><span id="loanmountlabel"><?php echo  number_format($loan_amount);?></strong></span><input type="text" name="changeamount" id="changeamount"  style=" width:100px; height: 25px;display:none;" value="<?php echo $loan_amount;?>"  onkeyup="summed1();"></td><tr>
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>Duration :&nbsp;&nbsp;</i><span id="loandurationlabel"><?php echo $termnmbr?></span> <input type="text" name="loanduation"  id="loanduation"  style=" width:40px; height: 25px;display:none" value="<?php echo $termnmbr;?>" onkeyup="summed1();"><?php echo $termype;?>(s)<input type="text" name="loanntype" id="loanntype" value="<?php echo $termype;?>" style="display:none"></strong></td><tr>
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>Rate :&nbsp;&nbsp;</i><span id="ratelabel"><?php echo $termRATE;?></span><input type="text" name="loanrate" id="loanrate"  style=" width:40px; height: 25px;display:none" value="<?php echo $termRATE;?>" onkeyup="summed1();">%</strong></td><tr>
<tr><td style=" text-indent: 30%;"><strong><font color="white" size="3"><i>Monthly Payment  :&nbsp;&nbsp;</i><span id="monthlylabel"><?php echo number_format($monthlypymt,2) ;?></span><input type="text" id="montlypymt" name="montlypymt"style=" width:90px; height: 25px;display:none" readonly/></strong></td><tr>
<tr><td style=" text-indent: 30%;"></td><tr>
</table><input type="submit" name="editloan"  value="Edit"></form><hr>
<div class="tab">
...
<table class="blueTable" border="0" align="center">
...
<?php
	...
	echo "<tr><td colspan='3'><h4 align='center'><font color='red'>  No Income!!!!</font></h1></td></tr>";
}	
?></table>
<hr>
</div>
 ...
 <table class="blueTable" align="center" >
	 <?php
        ...
        while($row = mysqli_fetch_array( $attcmt )) {
          ...
          if(!$filename ){
			  echo "<h4><Strong><font color='red'>No Attachment !!!</font></h4></strong>";
		  }
...
echo '<hr>';
	...
	echo "<tr><td colspan='2'><h4 align='center'><font color='red'>  Not Commented!!!!</font></h4></td></tr>";
 }
	   ?></table><br>
...
<?php
		...
		<tr><td></td><td bgcolor="black"><font color="white" size="5"><strong>Total Coraterals</font></strong></td><td colspan="2" bgcolor="black"><font color="white" size="5"><strong><?php echo  number_format($sumcorateral);?></strong></font></td></tr>
<?php
}
else{
