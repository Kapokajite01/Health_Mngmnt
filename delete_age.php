...
$deleteaGE = " DELETE FROM  age_custom  WHERE aage_id = '$ID ' ";
if ($conn->query($deleteaGE) === TRUE) {
echo "<script>alert('Successfully Deleted'); window.location='age_custom'</script>";
} else {
...
echo "<script>alert('Deleted Canceled'); window.location='age_custom'</script>";
