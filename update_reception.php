...
$sql="UPDATE receptionist SET first_name='$fname', last_name='$lname', staff_id='$sid',postal_address='$postal',phone='$phone',email='$email',username='$username', password='$pas' WHERE username='$username'";
...
<ul>
			...
			<li><a href="admin_reception.php">Receptionist</a></li>
			<li><a href="admin_stock.php">Stock Manager</a></li>
...
<hr/>	
    <div class="tabbed_area">  
		...
		<?php echo $message1;?>
          <form name="myform" onsubmit="return validateForm(this);" action="update_reception.php" method="post" >
