...
<form id="patient" name="patient" method="POST" action="saveCPN1">
...
<tr>
	  <td><fieldset  id="labtab" style="background:#e1eff2;width: 60%;">
        <span id="myBtn" style=" display: inline-block;background-color: green;border-radius: 10px;border: 4px double #cccccc;color: #eeeeee;  text-align: center;font-size: 14px; padding: 20px;width: 200px;-webkit-transition: all 0.5s;-moz-transition: all 0.5s;-o-transition: all0.5s;transition: all 0.5s; cursor: pointer;margin: 5px;"> EXAMS</span>
		<p><strong>
		<?PHP
		$labores = mysqli_query($conn, $labo);
...
<div><input type="text" id="myInput" onkeyup="searchfunc()" style="width:50%" placeholder="Search examen.." title="Type diagnostics name"><br><br></div>
 ...
 <form   method="POST" action="examesnSaveCpn">
