...
$id=$_POST['id'];
$date=$_POST['date'];
$result = ("SELECT patient.names,patient.lname,patient.affiliate_number,consomation.consid,consomation.id as pid,consomation.medicament,consomation.upmedicamnet,consomation.qtymedicamnet,consomation.datecunsuption 
FROM consomation JOIN patient on patient.id= consomation.id where medicament!='' AND consomation.id ='$id' and datecunsuption='$date'"); 
...
echo "<table border='1'>";
        ...
        while($row = mysqli_fetch_assoc( $resultselect )) {
				...
				<td><a href="edit_medicine1?consid=<?php echo $row['consid']?>"><img src="images/update-icon.png" width="24" height="24" border="0" /></a></td>
				<td><a href="delete_medicine1.php?consid=<?php echo $row['consid']?> &pid=<?php echo $row['affiliate_number']?>&consdate=<?php echo $row['datecunsuption']?>"><img src="images/delete-icon.jpg" width="24" height="24" border="0" /></a></td>
