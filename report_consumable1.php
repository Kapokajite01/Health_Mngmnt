...
<body id="dt_example">
		...
		<form method="post" action="report_medicine1">
			...
			<h4 align="center">PURCHASED  CONSUMABLES IN HEALTH CENTER ON &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $newdate; ?></strong></strong><hr></hr></h4>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
as totalpurchase,consomable_mvt.movment,consomable_mvt.bdate FROM consomable_mvt JOIN consommables on consomable_mvt.id= consommables.id WHERE consomable_mvt.movment ='Purchase' AND bdate= '$date' group by bdate,name_consommable order by bdate DESC , name_consommable"); 
