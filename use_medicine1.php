...
as totalsell,medicine_mvt.action,medicine_mvt.bdate FROM medicine_mvt JOIN prodicts on medicine_mvt.id= prodicts.id WHERE medicine_mvt.action ='OUT' AND bdate >='$date' AND bdate <='$date1' GROUP BY product_name ORDER BY bdate DESC,product_name"); 
