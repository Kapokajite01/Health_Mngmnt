...
<div class="row" > 
		...
		<thead  >
													...
													$query=mysqli_query($conn,"Select names ,lname,gender,dob,insurance,affiliate_number,patient_id,time_test      FROM consom_labs join patient ON patient.id = consom_labs.patient_id where time_test >= '$datesearch' AND time_test <= '$datesearch1' AND technid ='$userid' GROUP BY patient_id,time_test");
													if ($query->num_rows > 0) {
													...
													<tr style="border: 1px solid black;"> 
														...
														<td><p><font color="black"><?php echo $row['names'].'<br>'.$row['lname'];?></p></td>
