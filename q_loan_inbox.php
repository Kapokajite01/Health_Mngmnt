...
$role = $_SESSION['role'];
$newrole = $_SESSION['role'];

if((!$userid) OR ($role != 'Credit Committee')){
...
$numrowsbm= mysqli_num_rows($resultbm);
 ...
 $resultwait= "SELECT DISTINCT loan_id FROM loan_details where loan_status = 'Approved'  and contract_print = 'Contract printed'";
if ($resultwait=mysqli_query($con,$resultwait))
  {
$numrowapp1= mysqli_num_rows($resultwait);
  }
...
?><br><br>
						<div class="tabbable"><br>
							...
							<table id='dynamic-table' cellspacing="50">
...
echo "<tr><th ><strong>No</th><th><strong> Names</th><th><strong>Account Number</th><th><strong>Loan Type</th><th><strong>Amount</th><th>&nbsp;&nbsp;<strong>Term</th><th><strong>Rate</th><th><strong>Branch</th><th><strong>Attachments</th><th><strong>Time Application</th><th><strong>Q-Loan Score</th><th><strong>view</th></tr>";
				for($i == 0 ; $i<=2; $i++){ 
					...
					$track = $Row[13];
$mykey="myasdasasdasdyoooujshhslk";
$mystring =$Row[13];
$mymyvariable = $mystring ;
?>
    <tr>
...
<td><strong><a class="label label-sm label-success" href="loan_credit?1e0b22055bb538d12cf=<?php echo $mymyvariable;?>"<img src="images/mycommentt.jpg"  width="10" height="10" border="0"  />View</a></td></tr>
	<?php
}
...
echo"</table>"; 
 ?>	
												...
												<div class="panel panel-default">
													<div class="panel-heading">
														<a href="#faq-1-2" data-parent="#faq-list-1" data-toggle="collapse" class="accordion-toggle collapsed" style="background-color: #1abc9c">
															<i class="ace-icon fa fa-chevron-left pull-right" data-icon-hide="ace-icon fa fa-chevron-down" data-icon-show="ace-icon fa fa-chevron-left"></i>

															<h5><i><strong>Your Decision As  Credit Board Member &nbsp;&nbsp;<?php if ($numrowscm>0){echo '<strong><font color="tomato">['. $numrowscm.']</font></strong>';}else{echo '<strong>['. $numrowscm.']</strong>'; }?></strong></i></h5>
														</a>
													</div>
...
$result11 = "SELECT first_name,last_name,loan_details.loan_id,loan_details.loan_account,loan_details.loan_amount,loan_details.loan_type,loan_details.loan_status,loan_details.branch,loan_details.time_application,loan_details.loan_term_type,loan_details.loan_term_number,loan_details.loan_interest,loan_details.branch,loan_details.loan_tracknumber  FROM loan_details JOIN  loan_personalinfo ON loan_details.loan_tracknumber= loan_personalinfo.loan_id  where loan_status ='Sent To Credit Manager' order by loan_id ";
echo "<tr><th ><strong>No</th><th><strong> Track Number</th><th><strong>Account Number</th><th><strong>Loan Type</th><th><strong>Amount</th><th><strong>Term</th><th><strong>Rate</th><th><strong>Branch</th><th><strong>Attachments</th><th><strong>Time Application</th><th><strong>Q-Loan Score</th><th><strong>view</th></tr>";
				if ($result11=mysqli_query($con,$result11))
  {
		while($Row1 = mysqli_fetch_row($result11)){
					$track1 = $Row1[13];
	$checkdecision = "SELECT decider_id FROM decisions WHERE decider_id = '$userid' AND loan_id = '$track1'";
	$resultdecider = mysqli_query($con,$checkdecision);
	$numdeciders = mysqli_num_rows($resultdecider);
if($numdeciders == 0){
...
<td><strong><a class="label label-sm label-success" href="loan_credits?b12b5382d1e0b205cf5=<?php echo $myvariable;?>"<img src="images/mycommentt.jpg"  width="10" height="10" border="0"  />View</a></td></tr>
	<?php
}
}
  }

echo "<tr><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th><th ><strong><hr></strong></th></tr>";

//Awaiting for Decision
$result1110 = "SELECT first_name,last_name,loan_details.loan_id,loan_details.loan_account,loan_details.loan_amount,loan_details.loan_type,loan_details.loan_status,loan_details.branch,loan_details.time_application,loan_details.loan_term_type,loan_details.loan_term_number,loan_details.loan_interest,loan_details.branch,loan_details.loan_tracknumber  FROM loan_details JOIN  loan_personalinfo ON loan_details.loan_tracknumber= loan_personalinfo.loan_id  where loan_status ='Sent To Credit Manager' order by loan_id ";


					if ($result1101=mysqli_query($con,$result1110))
  {
	
	
	
	while($Row1101 = mysqli_fetch_row($result1101)){
					$track11101 = $Row1101[13];
	$checkdecision1101 = "SELECT decider_id FROM decisions WHERE decider_id = '$userid' AND loan_id = '$track11101'";
	$resultdecider1101 = mysqli_query($con,$checkdecision1101);
	$numdeciders1101 = mysqli_num_rows($resultdecider1101);
if($numdeciders1101 > 0){
	$key="asdasasdasdy@&!qweuhasduisd";
$string =$Row1101[13];
$myvariable1101 = $string;
?>

	<tr bgcolor="#FFEFD5">
	<td> <strong><?php echo ++$ij;?></td>
	<td><strong> <?php echo $Row1101[0].'&nbsp;&nbsp;'.$Row1101[1];?></strong></td>
	<td> <?php echo  $Row1101[3];?> </td>
	<td> <?php echo  $Row1101[5];?> </td>
	<td> <?php echo  $Row1101[4];?> </td>
	<td> &nbsp;&nbsp;<?php echo  $Row1101[10].'&nbsp'.$Row1101[9];?>(s)</td>
	<td> <?php echo  $Row1101[11];?>%</td>
	<td> <?php echo  $Row1101[12];?></td>
	<td><?php 
	$attachments1101 = "SELECT  loan_id FROM myfiles where loan_id = '$track11101'";
	if ($attachments1101=mysqli_query($con,$attachments1101))
  {
	$num_attac1101 = mysqli_num_rows($attachments1101);
	...
	<?php echo 	"<td> $Row1101[8]</td>";?>
<td>
		<?php $score11101 = "SELECT  * FROM score_table where track_number = '$track11101'";
		$totscoreperc11101=0;
		if ($score1=mysqli_query($con,$score11101))
  {
		while($rowscore11101 = mysqli_fetch_array($score11101)){
			$sduration11101= $rowscore11101['score_duration'];
			$shistory11101= $rowscore11101['score_hostory'];
			$scustduration11101= $rowscore11101['score_cust_duration'];
			$sage11101= $rowscore11101['score_age'];
			$sgender11101= $rowscore11101['score_gender'];
			$sstatus11101= $rowscore11101['score_stauts'];
			$sactivity11101= $rowscore11101['score_activity'];
			$totscore11101 = $sduration11101+$shistory11101+$scustduration11101+$sage1+$sgender11101+$sstatus11101+$sactivity11101;
			$totscoreperc11101 = $totscore11101/7;
			$totscoreperc11101 = round ($totscoreperc11101);
		}
  }
		?>
	...
	<?php
$board1101= "SELECT  * FROM users_table WHERE role = 'Credit Committee' OR role = 'Credit Manager'";
 $resultboard1101 = $conn_db->query($board1101);
if ($resultboard1101->num_rows > 0) {
	$totdeccredit1101=0;
	 $numrowscre1101= mysqli_num_rows($resultboard1101);

while($rowboard1101 = $resultboard1101->fetch_assoc()) {
	$name1101 = $rowboard1101['First_Nmae'];
	$lname1101 = $rowboard1101['lname'];
	$uid1101 = $rowboard1101['id'];
	$selectdecision1101 = "SELECT *  FROM decisions where decider_id = '$uid1101' AND loan_id ='$track11101'" ;
	$resuldeci1101 = $conn_db->query($selectdecision1101);
if ($resuldeci1101->num_rows > 0) {
	
while($rowdecis1101 = $resuldeci1101->fetch_assoc()) {
	$creditcommitteescore1101=0;
$cudecision1101 = $rowdecis1101['decision'];
if($cudecision1101 == 'Approved'){
$creditcommitteescore1101 = $creditcommitteescore1101 + 95;
}
if($cudecision1101 == 'Pended'){
$creditcommitteescore1101 = $creditcommitteescore1101 + 55;
}
if($cudecision1101 == 'Denied'){
$creditcommitteescore1101 = $creditcommitteescore1101 + 5;
}
}
$totdeccredit1101 = $totdeccredit1101+$creditcommitteescore1101;
}
...
$avecredit1101 = $totdeccredit1101/$numrowscre1101;

// SELECT SCORE FOR HQ
$boardhq1101= "SELECT  * FROM users_table WHERE role = 'Branch Manager' OR role = 'Head Office Committee'";
 $resultboard1101 = $conn_db->query($boardhq1101);
if ($resultboard1101->num_rows > 0) {
	$hqscore1101 = 0;
	 $numrowshq1101= mysqli_num_rows($resultboard1101);
...
while($rowboard1101 = $resultboard1101->fetch_assoc()) {
	...
	$selectdecision1101 = "SELECT *  FROM hq_decisions where decider_id = '$uid1101' AND loan_id ='$track11101' " ;
	$resuldeci1101 = $conn_db->query($selectdecision1101);
if ($resuldeci1101->num_rows > 0) {
while($rowdecis1101 = $resuldeci1101->fetch_assoc()) {
$cudecision1101 = $rowdecis1101['decision'];
...
$cudecision1101 = 'No Decision';	
}
if($cudecision1101 == 'No Decision'){
	$hqcommitteescore1101 = $hqcommitteescore1101 + 0;
}
if($cudecision1101 == 'Approved'){
		$hqcommitteescore1101 = $hqcommitteescore1101 + 95;
}
if($cudecision1101 == 'Pended'){
		$hqcommitteescore1101 = $hqcommitteescore1101 + 55;
}
if($cudecision1101 == 'Denied'){
		$hqcommitteescore1101 = $hqcommitteescore1101 + 5;
}
$hqscore1101 = $hqscore1101 + $hqcommitteescore1101;
$hqaver1101 = $hqscore1101 / $numrowshq1101;
}
}
$overallaverage1101= ($totscoreperc11101 +$avecredit1101)/3;
$overallaverage1101 = round($overallaverage1101);
...
?>
	...
	<span><strong>Scored &nbsp;&nbsp; <?php echo $overallaverage1101;?>%</strong></span>

<div class="progress">
   <?php 

   if($overallaverage1101 <50){
   
   echo "<div class='progress-bar progress-bar-danger  progress-bar-striped' role='progressbar'
  aria-valuenow=$overallaverage1101 aria-valuemin='0' aria-valuemax='100' style='width:$overallaverage1101%'>
    
  </div>";
   }
if($overallaverage1101 == 0){
...
if($overallaverage1101 >=50 AND $overallaverage1101 <75){
...
<td><strong><a class="label label-sm label-success" href="loan_credits?b12b5382d1e0b205cf5=<?php echo $myvariable1101;?>"<img src="images/mycommentt.jpg"  width="10" height="10" border="0"  />View</a></td></tr>
	<?php
}
}
  ...
  ?>
				...
				<?php
$result22 = "SELECT first_name,last_name,loan_details.loan_id,loan_details.loan_account,loan_details.loan_amount,loan_details.loan_type,loan_details.loan_status,loan_details.branch,loan_details.time_application,loan_details.loan_term_type,loan_details.loan_term_number,loan_details.loan_interest,loan_details.branch,loan_details.loan_tracknumber  FROM loan_details JOIN  loan_personalinfo ON loan_details.loan_tracknumber= loan_personalinfo.loan_id where loan_status ='Sent To Branch Manager' ORDER BY loan_id ";
echo "<tr><th ><strong>No</th><th><strong> Names</th><th><strong>Account Number</th><th><strong>Loan Type</th><th><strong>Amount</th><th><strong>Term</th><th><strong>Rate</th><th><strong>Branch</th><th><strong>Attachments</th><th><strong>Time Application</th><th><strong>Q-Loan Score</th><th><strong>view</th></tr>";
 ...
 ?>	
												...
												<div class="panel panel-default">
													<div class="panel-heading">
                                                       ...
                                                       <h5><strong>For Contract Generation &nbsp;&nbsp;<?php if ($numrowapp>0){echo '<strong><font color="tomato">['. $numrowapp.']</font></strong>';}else{echo '<strong>['. $numrowapp.']</strong>'; }?>
                                                      - Waiting For Repayment &nbsp;&nbsp;<?php if ($numrowapp1>0){echo '<strong><font color="tomato">['. $numrowapp1.']</font></strong>';}else{echo '<strong>['. $numrowapp1.']</strong>'; }?></strong></h5>
														</a>
													</div>
