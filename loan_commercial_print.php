...
$userid = $_SESSION['userid'];
$crtoken = $_GET['eeefXZA5432Tgfeeekl'];
$token = $crtoken;
/*$crtoken = preg_replace('/\s+/', '+', $crtoken);

  list($crtoken, $enc_iv) = explode("::", $crtoken);;
...
if($ovaverage >=75){
  ...
  ?></div></div>
						...
						<button type="button" class="btn btn-success dropdown-toggle btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						  ...
						  <?php 
						  if($loan_status=='Contract printed'){
						  echo '
                          <div class="dropdown-menu">
                            

                            <div class="dropdown-divider"></div>
								                            <button class="dropdown-item" onClick=window.open("start_repayment","Ratting","width=800,height=500,left=450,top=80,toolbar=0,status=0,"); accesskey="1">
                              <i class="fa fa- fa-keyboard-o"></i>Start Repayment</button>
                            <button class="dropdown-item" onClick=window.open("loan_contract","Ratting","width=1800,height=1000,left=450,top=80,toolbar=0,status=0,"); accesskey="1">
                              <i class="fa fa-print"></i>Reprint Contract</button>
                          ...
                          <div class="dropdown-menu">
                            ...
                            <div class="dropdown-divider"></div>
                            <button class="dropdown-item" onClick=window.open("loan_contract","Ratting","width=1800,height=1000,left=450,top=80,toolbar=0,status=0,"); accesskey="1">
                              <i class="fa fa-print"></i>Print Contract</button>
