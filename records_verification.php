...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
  <tr>
      ...
      ?>
    ...
    </select><input type="text" name="fname"><input type="text" name="lname">
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
			  <form method="POST" action="incomes1.php">
                <td width="45"></td>
                <td width="393"><strong>All INCOMES FOR:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $today; ?> </strong></td>
                ...
                <td width="116"><input type="text" name="datesearch1" id="datesearch1" required aria-required='true' aria-describedby='name-format' placeholder="End Date" /></td>
        ...
        <tr>
          <td><table cellpadding="1" cellspacing="1" border="0" class="altrowstable">
			...
			<th>COST FOR CARNET</th>
			<th>COST FOR PHOTOCOPY</th>
			<th>COST FOR TRANSFERT</th>
