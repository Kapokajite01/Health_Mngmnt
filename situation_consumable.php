...
<body id="dt_example">
		...
		<form method="post" action="use_consumable1">
			...
			<h4 align="center">STOCK OF CONSUMABLES ON &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date('d') ?>-<?php echo date('F') ?> -<?php echo date('Y') ?></strong><hr></hr></h4>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$num=0;
$grandsum=0;
$result = ("SELECT * FROM consommables where destination!='Ordinary Stock' OR destination='' ORDER BY name_consommable"); 
while ($row = mysqli_fetch_assoc($result))
{ 
$num=$num+1;
$tot=$row['unit_pricec']* $row['reamin'];
?>
					<tr>
						<td><?php echo $num;?></td>				
						<td><?php echo $row['name_consommable'];?></td>				
						<td><?php echo $row['dist_quantity'];?></td>				
						<td><?php echo $row['reamin'];?></td>				
						<td><?php echo $row['qntity'];?></td>				
						<td><?php echo $row['unit_pricec'];?></td>				
						<td><?php echo $tot;?></td>				
					</tr>
					<?php 
					$total=$total+$tot;
